...
IntegerToByteString = wrap_builtin_ternop(uplc_ast.BuiltInFun.IntegerToByteString)
ByteStringToInteger = wrap_builtin_binop(uplc_ast.BuiltInFun.ByteStringToInteger)
AndByteString = wrap_builtin_ternop(uplc_ast.BuiltInFun.AndByteString)
OrByteString = wrap_builtin_ternop(uplc_ast.BuiltInFun.OrByteString)
XorByteString = wrap_builtin_ternop(uplc_ast.BuiltInFun.XorByteString)
